...
public enum EnemyType
{
    ...
    ROBERT		(	2f, 2.3f, Constants.ENEMY_X, Constants.ROBERT_ENEMY_Y, Constants.ENEMY_DENSITY, Constants.ROBERT_ENEMY_REGION_NAMES),
    ...
    ALPHONSE		(	1.8f, 2.3f, Constants.ENEMY_X, Constants.ALPHONSE_ENEMY_Y, Constants.ENEMY_DENSITY, Constants.ALPHONSE_ENEMY_REGION_NAMES),
    HELLBOY		(	2f, 2.3f, Constants.ENEMY_X, Constants.HELLBOY_ENEMY_Y, Constants.ENEMY_DENSITY, Constants.HELLBOY_ENEMY_REGION_NAMES);
